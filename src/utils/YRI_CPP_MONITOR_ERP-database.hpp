/*
 * YRI_CPP_MONITOR_ERP-database.hpp
 *
...
#include "src/utils/YRI_CPP_UTILS.hpp"
...
public:
    ...
    YRI_CPP_CLASS_OPERATORS YRI_CPP_MONITOR_ERP_database();

    inline ~ YRI_CPP_MONITOR_ERP_database()
    {
    }
